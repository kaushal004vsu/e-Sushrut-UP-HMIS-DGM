...
public class EncounterDetail__2 {
    ...
    @SerializedName("encounter_type_code")
    @Expose
    ...
    @Expose
    private String bed;
    @SerializedName("bed_code")
    @Expose
    private String bedCode;
    @SerializedName("encounter_status")
    @Expose
    private String encounterStatus;
    @SerializedName("encounter_status_code")
    @Expose
    private String encounterStatusCode;
    @SerializedName("visit_date")
    @Expose
    private String visitDate;
    @SerializedName("admission_datetime")
    @Expose
    private String admissionDatetime;
    @SerializedName("encounter_date")
    @Expose
    private String encounterDate;
    @SerializedName("encounter_start_date")
    @Expose
    private String encounterStartDate;
    @SerializedName("encounter_end_date")
    @Expose
    private String encounterEndDate;
    @SerializedName("discharge_datetime")
    @Expose
