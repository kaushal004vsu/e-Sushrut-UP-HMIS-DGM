...
public class EHRJsonDetails {
    ...
    @Expose
    private List<String> invTestCode = null;
    @SerializedName("InvTestCodeToPrint")
    @Expose
    private List<String> invTestCodeToPrint = null;
    @SerializedName("DrugCodeCat")
    @Expose
    private List<String> drugCodeCat = null;

    @SerializedName("ReasonOfVisit")
    @Expose
    private List<String> reasonOfVisit = null;
    ...
    @Expose
    private List<String> strClinicalProcedure = null;
    ...
    public EHRJsonDetails(List<String> invTestCode, List<String> invTestCodeToPrint, List<String> drugCodeCat, List<String> reasonOfVisit, List<String> diagnosis, List<FollowUp> followUp, String patName, String cRNo, String episodeCode, String episodeVisitNo, String currentVisitDate, String patVisitType, String lastVisitDate, String patGender, String patAge, String patCat, String patQueueNo, String hospCode, String seatId, Integer hrgnumIsDocuploaded, String patConsultantName, String patDept, String patGaurdianName, String patCompleteGeneralDtl, StrCompleteHistory strCompleteHistory, StrSystematicExamniation strSystematicExamniation, List<Object> strChronicDisease, String strHistoryOfPresentIllNess, String strDiagnosisNote, List<Object> strDrugAllergy, String strInvestgationNote, String strotherAllergies, List<String> strClinicalProcedure, String strtreatmentAdvice, String strVitalsChart, Strpiccle strpiccle, String strConfidentialsInfo, List<Object> strReferal, String strDeptIdflg, String strAllDeptIdflg, String strPresCriptionBookmarkNameval, String strPresCriptionBookmarkDescVal, String strUmidNo, String admissionadviceDeptName, String admissionadviceWardName, String admissionadviceNotes, String strDesignation, String strStation) {
    ...
    public List<String> getInvTestCode() {
        return invTestCode;
    }

    public void setInvTestCode(List<String> invTestCode) {
        this.invTestCode = invTestCode;
    }

    public List<String> getInvTestCodeToPrint() {
        return invTestCodeToPrint;
    }

    public void setInvTestCodeToPrint(List<String> invTestCodeToPrint) {
        this.invTestCodeToPrint = invTestCodeToPrint;
    }

    public List<String> getDrugCodeCat() {
        return drugCodeCat;
    }

    public void setDrugCodeCat(List<String> drugCodeCat) {
        this.drugCodeCat = drugCodeCat;
    }

    public List<String> getReasonOfVisit() {
        return reasonOfVisit;
    }

    public void setReasonOfVisit(List<String> reasonOfVisit) {
        this.reasonOfVisit = reasonOfVisit;
    }
    ...
    public List<String> getStrClinicalProcedure() {
        return strClinicalProcedure;
    }

    public void setStrClinicalProcedure(List<String> strClinicalProcedure) {
        this.strClinicalProcedure = strClinicalProcedure;
    }
