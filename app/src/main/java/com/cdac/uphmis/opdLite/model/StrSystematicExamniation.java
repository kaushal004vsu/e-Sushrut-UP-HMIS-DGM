...
private String strLocalExamn="";
    ...
    public StrSystematicExamniation() {
    }

    public StrSystematicExamniation(String strcvs, String strrs, String strcns, String strpA, String strotherExamn, String strmuscularExamn, String strLocalExamn) {
        this.strcvs = strcvs;
        this.strrs = strrs;
        this.strcns = strcns;
        this.strpA = strpA;
