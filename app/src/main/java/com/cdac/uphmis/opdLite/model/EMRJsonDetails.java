...
public class EMRJsonDetails {
    ...
    @Expose
    private List<ComplaintsJsonArray> reasonOfVisitJsonArray = null;
    ...
    @Expose
    private List<InvestigationJsonArray> investigationJsonArray = null;
    ...
    @Expose
    private List<ProceduresJsonArray> clinicalProcedureJsonArray = null;
    ...
    public List<ComplaintsJsonArray> getReasonOfVisitJsonArray() {
        return reasonOfVisitJsonArray;
    }

    public void setReasonOfVisitJsonArray(List<ComplaintsJsonArray> reasonOfVisitJsonArray) {
        this.reasonOfVisitJsonArray = reasonOfVisitJsonArray;
    }
    ...
    public List<InvestigationJsonArray> getInvestigationJsonArray() {
        return investigationJsonArray;
    }

    public void setInvestigationJsonArray(List<InvestigationJsonArray> investigationJsonArray) {
        this.investigationJsonArray = investigationJsonArray;
    }
    ...
    public List<ProceduresJsonArray> getClinicalProcedureJsonArray() {
        return clinicalProcedureJsonArray;
    }

    public void setClinicalProcedureJsonArray(List<ProceduresJsonArray> clinicalProcedureJsonArray) {
        this.clinicalProcedureJsonArray = clinicalProcedureJsonArray;
    }
